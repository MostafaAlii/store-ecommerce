...
@section('content')
    ...
    <!-- Start Pending Rows Content -->
    <div class="row card_boxes">
        <!-- Start Pending Requests Card -->
        <div class="col-xl-3 col-md-6 mb-4 requests_pending_card">
            <div class="card shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2 requests_pending_info">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">{{ trans('admin.pending_requests') }}</div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                ...
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                                        <div class="progress-bar-animated bg-warning" role="progressbar" style="width: 30%; float: right;" dir="rtl" aria-valuenow="35" aria-valuemin="0" aria-valuemax="80"></div>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <i class="card_icon fa fa-clipboard fa-2x"></i>
                                </div>
                            </div>
                        </div>
                    </div>
